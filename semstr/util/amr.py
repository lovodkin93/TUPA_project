...
prev_dir = os.getcwd()
try:
    os.chdir(os.path.dirname(util.find_spec("semstr.src.amr").origin))  #os.chdir(os.path.dirname(util.find_spec("src.amr").origin))  # to find amr.peg
    from semstr.src import amr as amr_lib #from src import amr as amr_lib
finally:
    os.chdir(prev_dir)
